...
Every contribution to the Grafana Istio Plugin is welcome, whether it is
reporting a bug, submitting a fix, proposing new features or becoming a
maintainer. To make contributing to the Grafana Istio Plugin as easy as possible
you will find more details for the development flow in this documentation.
...
- Search through
  [existing open and closed GitHub Issues](https://github.com/ricoberger/grafana-istio-plugin/issues)
  for the answer first. If you find a relevant topic, please comment on the
  issue.
- If none of the issues are relevant, please add an
  [issue](https://github.com/ricoberger/grafana-istio-plugin/issues). Please use
...
[GitHub](https://github.com/ricoberger/grafana-istio-plugin/security/advisories).

## Adding new Features

When contributing a complex change to the Grafana Istio Plugin, please discuss
